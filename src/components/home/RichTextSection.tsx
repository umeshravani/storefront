    ...
    <section className="w-full bg-white py-16 md:py-24 px-4">
      <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
          From modern prints to rare originals, explore a curated collection
          that celebrates creativity, color, and culture.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="h-12 px-8 rounded-full border-black hover:bg-gray-50"
          >
